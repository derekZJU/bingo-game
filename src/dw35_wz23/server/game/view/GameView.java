...
public class GameView extends JFrame implements Serializable{
	...
	private int MIN_ALTITUDE = 100000;
	private int MAX_ALTITUDE = 1500000;
	...
	private JLabel timeLabel = new JLabel("15:00");
	...
	double[] latitude = {
			...
			25.05, 1.307, 53.5, 25.6, 52.527, 55.678, 45.6, 47.8,
	...
	double[] longitude = {
			...
			121.57, 103.823, -113.4, -100.2, 13.41, 12.569, 4.9,107.03,
	...
	public void init(){
		...
		timePanel.add(new JLabel("Total Time: 15:00, Your time: "));
		timePanel.add(timeLabel);
		toolPanel.add(timePanel, BorderLayout.EAST);
	 ...
	 * @param l	index of label
	 * @param owner which team to own the dish
	 */
	...
	/**
	 * update the labels by the data in matrix
	 * @param matrix data source
	 */
